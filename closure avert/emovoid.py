...
"""
EmoVoid v3.9.0 Test (260510) Moment-Free Edition 全統合版(CPU-GPUデータ転送対応含む)
...
if not hasattr(torch.optim.Optimizer, "_manual_loss"):
    ...
    print("🚩 emo-optim success hook system ...")

class EmoVoid(Optimizer):    # クラス定義＆初期化
    ...
    def step(self, closure=None):
        ...
        #print(f"Loss: {loss_val:.4f} | Scalar: {scalar:.6f} | Pulse: {emoPulse:.6f}")
