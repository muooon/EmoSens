...
"""
EmoTion v3.9.1 (260530) Moment-Free Edition ECC版(CPU-GPUデータ転送対応含む)
...
usage ／ 使い方
--optimizer_type=optimizer.emotion.EmoTion
...
class EmoTion(Optimizer):    # クラス定義＆初期化
    def __init__(self, params,
        ...
        self._init_lr = lr; self.beta3 = 1.0 - betas[0]
    ...
    def step(self, closure=None):
        ...
        with torch.no_grad():
            ...
            if prev is not None:
                ...
                self.g_freshness = max(math.tanh(gratio / 0.03), self.beta3)
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                # 慣性と勾配の直交性で混ぜる (freshness は 0 にならず/beta3下限値で膠着回避)
